...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<?php
			...
			// Select mameinfo text

			$query = 'SELECT text
				FROM mameinfo_link, mameinfo_text
				WHERE mameinfo_link.game_name=' . "'" . $_GET ['id'] . "'" . ' AND
				mameinfo_text.mameinfo_id=mameinfo_link.mameinfo_id
				ORDER BY mameinfo_text.line_no';
